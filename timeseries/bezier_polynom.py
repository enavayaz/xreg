...
class BezierPolynom:
    ...
    def __init__(self, M: Manifold, control_points: jnp.array):
        """
    ...
    def __str__(self) -> str:
        return 'Bézier polynom through ' + str(self._M)
    ...
    def tangent(self, t: float) -> jnp.array:
        ...
        def bezier_tangent(bet:BezierPolynom, s):
            """
        ...
        return bezier_tangent(BezierPolynom(self._M, self.control_points), t)
    ...
    def eval(self, t: float) -> jnp.array:
        ...
        return decasteljau(self._M, self.control_points, t)[0]
